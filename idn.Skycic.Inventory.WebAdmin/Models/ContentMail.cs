...
namespace idn.Skycic.Inventory.Web.Models
{
    public class BodyEMail
    {
        ...
        public static string GetContentMailRegister(Mst_NNT data)
        {
            ...
            sbBodyHTML.Append(@"<p class=""padding-left-right-40 padding-top-10 padding-bottom-5 font-size-25 color-white""> Long Quang thông báo tài khoản đăng nhập và xác nhận đơn đặt hàng phần mềm Inbrand Clound của Quý khách. </p>");
            sbBodyHTML.Append(@"</div>");
            ...
            sbBodyHTML.Append(@"<p class=""padding-top-15"">Công ty  CÔNG TY CỔ PHẦN QUỐC TẾ LONG QUANG xin chân thành cảm ơn Quý khách đã tin tưởng, lựa chọn sử dụng phần mềm Inbrand Clound</p>");
            sbBodyHTML.Append(@"<p class=""padding-top-15"">Long Quang xin thông báo tài khoản đăng nhập sử dụng dịch vụ xác thực nguồn gốc sản phẩm và thông tin đơn đặt hàng của Quý khách như sau:</p>");
            sbBodyHTML.Append(@"<ul class=""list-style-none"">");

            sbBodyHTML.Append(@"<li>");
            sbBodyHTML.Append(@"<span class=""font-weight-bold"">1. Thông tin tài khoản kết nối với dịch vụ xác thực nguồn gốc sản phẩm Inbrand Clound:</span>");
            ...
            sbBodyHTML.Append(@"<p class=""padding-top-10"">Tài khoản này dùng để sử dụng dịch vụ xác thực nguồn gốc sản phẩm Inbrand Clound tại địa chỉ <a class=""font-weight-bold color-blue"" href=""http://test.inbrand.vn:12071"">http://test.inbrand.vn:12071</a>.</p>");
            sbBodyHTML.Append(@"</div>");
            sbBodyHTML.Append(@"</li>");
            ...
            sbBodyHTML.Append(@"<li class=""padding-top-15 clear-fix"">");
            sbBodyHTML.Append(@"<span class=""font-weight-bold"">2. Thông tin Long Quang xuất hóa đơn cho Quý khách:</span>");
            ...
            sbBodyHTML.Append(@"<li class=""padding-top-15 clear-fix"">");
            sbBodyHTML.Append(@"<span class=""font-weight-bold"">ĐƠN VỊ CUNG CẤP DỊCH VỤ INBRAND CLOUND:</span>");
            sbBodyHTML.Append(@"<div class=""div-li3 div-border-radius padding-left-right-25"" style=""min-height: 150px;"">");
            sbBodyHTML.Append(@"<p class=""padding-top-10""><span class=""font-weight-bold color-black"">Công ty  CÔNG TY CỔ PHẦN QUỐC TẾ LONG QUANG</span></p>");
