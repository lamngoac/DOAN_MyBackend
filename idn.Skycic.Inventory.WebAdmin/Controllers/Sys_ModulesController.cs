...
{
    public class Sys_ModulesController : BaseController
    {
        // Quản lý gói Module
        // GET: Sys_Modules
        #region["Index"]
        public ActionResult Index(string init = "init", int page = 0)
        {
            ...
            if (userState.RptSv_Sys_User.FlagSysAdmin.Equals("1"))
            {
                ...
                if (listSys_Solution != null && listSys_Solution.Count > 0)
                {
                    ...
                    {
                        solutionCode = CUtils.StrValue(listSys_Solution[0].SolutionCode);
                    }
                    if (!CUtils.IsNullOrEmpty(listSys_Solution[0].SolutionName))
                    {
                        solutionName = CUtils.StrValue(listSys_Solution[0].SolutionName);
                    }
                }
                ...
                if (init != "init")
                {
                    ...
                    var objRT_Sys_ModulesCur = Sys_ModulesService.Instance.WA_RptSv_Sys_Modules_Get(objRQ_Sys_Modules, addressAPIs);
        ...
        public ActionResult Create(string model)
        {
            ...
            try
            {
                if (userState.RptSv_Sys_User.FlagSysAdmin.Equals("1"))
                {
                    ...
                    Sys_ModulesService.Instance.WA_RptSv_Sys_Modules_Create(objRQ_Sys_Modules, addressAPIs);
                ...
                if (userState.RptSv_Sys_User.FlagSysAdmin.Equals("1"))
                {
                    if (!CUtils.IsNullOrEmpty(model))
                    {
                        ...
                        if (objRT_Sys_ModulesCur.Lst_Sys_Modules != null && objRT_Sys_ModulesCur.Lst_Sys_Modules.Count > 0)
                        {
                            ...
                            Sys_ModulesService.Instance.WA_RptSv_Sys_Modules_Update(objRQ_Sys_Modules, addressAPIs);
            ...
            if (userState.RptSv_Sys_User.FlagSysAdmin.Equals("1"))
            {
                if (!CUtils.IsNullOrEmpty(modulecode))
                {
                    ...
                    if (objRT_Sys_ModulesCur.Lst_Sys_Modules != null && objRT_Sys_ModulesCur.Lst_Sys_Modules.Count > 0)
                    {
                        ...
                        Sys_ModulesService.Instance.WA_RptSv_Sys_Modules_Delete(objRQ_Sys_Modules, addressAPIs);
        ...
        public ActionResult GetSysObject(string modulecode = "")
        {
            ...
            try
            {
                if (userState.RptSv_Sys_User.FlagSysAdmin.Equals("1"))
                {
                    ...
                    var objRT_Sys_ObjectInModules = Sys_ObjectInModulesService.Instance.WA_RptSv_Sys_ObjectInModules_Get(objRQ_Sys_ObjectInModules, addressAPIs);
                ...
                if (userState.RptSv_Sys_User.FlagSysAdmin.Equals("1"))
                {
                    ...
                    if (RQ_Sys_ObjectInModulesUI != null)
                    {
                        ...
                        if (RQ_Sys_ObjectInModulesUI.Lst_Sys_ObjectInModulesUI == null || RQ_Sys_ObjectInModulesUI.Lst_Sys_ObjectInModulesUI.Count == 0)
                        {
                            ...
                            Sys_ObjectInModulesService.Instance.WA_RptSv_Sys_ObjectInModules_Save(objRQ_Sys_ObjectInModules, addressAPIs);
                            flagSuccess = "1";
                            title = "Xóa function thành công!";
                        }
                        else
                        {
                        ...
                        return Json(new { Success = true, Title = title, FlagSuccess = flagSuccess });
                    }
                    else
                    {
                        return Json(new { Success = true, Title = "Chưa chọn function gán vào module!", FlagSuccess = flagSuccess });
                    }
                }
                else
                {
                    ...
                    if (objRT_Sys_ModulesCur != null && objRT_Sys_ModulesCur.Lst_Sys_Modules != null)
                    {
                        ...
                        if (pageCount > 1)
                        {
                            for (var i = 1; i <= pageCount; i++)
                            {
                                ...
                                var objRT_Sys_ModulesExportCur = Sys_ModulesService.Instance.WA_RptSv_Sys_Modules_Get(objRQ_Sys_Modules, addressAPIs);
        ...
        private string strWhereClause_Sys_Modules(Sys_Modules data)
        {
            ...
            {
                sbSql.AddWhereClause(Tbl_Sys_Modules + TblSys_Modules.ModuleCode, CUtils.StrValue(data.ModuleCode), "=");
            }
            if (!CUtils.IsNullOrEmpty(data.FlagActive))
            {
                sbSql.AddWhereClause(Tbl_Sys_Modules + TblSys_Modules.FlagActive, CUtils.StrValue(data.FlagActive), "=");
            }
