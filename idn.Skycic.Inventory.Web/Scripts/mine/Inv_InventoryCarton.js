function Inv_InventoryCarton() {
    ...
    this.getData = function () {
        ...
        var canno = commonUtils.returnValueText('#CanNo');
        var qr_thung = commonUtils.returnValueText('#qr_thung');

        var objInv_InventoryCarton = new Object();
        objInv_InventoryCarton.OrgId = orgid;
        objInv_InventoryCarton.Qty = qty;
        objInv_InventoryCarton.CanNo = canno;
        objInv_InventoryCarton.qr_thung = qr_thung;
        var modelCur = commonUtils.returnJSONValue(objInv_InventoryCarton);
        var data = {
    ...
    this.deleteData = function (objInv_InventoryCarton) {
        var ifinvinfgno = commonUtils.returnValue(objInv_InventoryCarton.IF_InvInFGNo);
