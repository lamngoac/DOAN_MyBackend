    ...
    public static class ErrorExtensions
    {
        public static IHtmlString ToHtml(this Exception ex)
        {
            ...
            if (ex is ClientException)
            {
                ...
                var strError = "<div style=\"width: 100%; padding: 5px 0 10px 0; float: left;\"><span style=\"color: #000000; font-family: 'Open Sans', sans-serif; font-weight: bold; font-size: 18px;\">ErrorMessage: " + errorMessage + "</span></div>";
